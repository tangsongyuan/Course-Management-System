...
<html>
	...
	<body>
		<?php
		    ...
		    // $user = "b395a747b4ed28";                     //Your Cloud 9 username
		    // $pass = "14105227";                                  //Remember, there is NO password by default!
		    // $db = "heroku_e8a078c57fe42a2";                                  //Your database name you want to connect to
		    // $port = 3306;                                //The port #. It is always 3306
		...
		<nav class="navbar navbar-default">
		    <div class="container">
		        <div class="navbar-header">
		            ...
		            <a class="navbar-brand" href="/index.php">CourseManager</a>
		        </div>
